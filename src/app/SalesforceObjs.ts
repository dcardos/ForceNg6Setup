...
export class PricingObject {
    ...
    API_NET_Total_Debit__c;
    API_NET_Total_Credit__c;
    API_NET_Total_Credit2x6__c;
    API_NET_Total_Credit7x12__c;
    API_Net_Debito_Elo__c;
    API_Net_Credito_Elo__c;
    API_Net_Credito_2x6_Elo__c;
    API_Net_Credito_7x12_Elo__c;
    API_Net_Credito_Hiper__c;
    API_Net_Credito_2x6_hiper__c;
    API_Net_Credito_7x12_hiper__c;
    API_Net_Credito_Amex__c;
    API_Net_Credito_2x6_Amex__c;
    API_Net_Credito_7x12_Amex__c;
