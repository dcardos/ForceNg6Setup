...
gulp.task('prepareForDeploy', () => {
  ...
  return run('python salesforce/visualforce_transform.py --assets sfRenegociacaoAssets --controller newRenegotiationController --pagename RenegociacaoPage --builddir src-dev-deploy').exec('', function(e) {
    if (e && e.status) {
